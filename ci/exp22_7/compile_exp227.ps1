...
$manifest.Add('EXP22_7_PatchSHA256=04998D9BA9717F6D1612B3A8F39B48F0E8F92AE3494F8C037F376B176DC22444')
...
Write-Host 'EXP22_7_COMPILE=PASS RELEASE_X64=1 RADIANT_BUILT=0'
